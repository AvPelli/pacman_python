...
class FruitSelector:
    ...
    def update_candies_active(self):
        """
        This method subtract 1 from the active candy amount, is called whenever pacman eats a candy. This variable
    ...
    def get_score(self):
        ...
        themselves, which only returns their true score once (before they are eaten)
